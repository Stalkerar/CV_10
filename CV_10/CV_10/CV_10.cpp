...
private:
	...
	double _vyska;
public:
	Shape(double sirka, double vyska)
	{
		_sirka = sirka;
		_vyska = vyska;
	}
...
public:
	Shapes()
	{
		collection = (Shape**)malloc(sizeof(Shape)*10);
		count = 0;
	}
...
{
public:
	Rectangle(double sirka, double vyska) : Shape(sirka, vyska)
	{
...
{
public:
	Circle(int prumer) : Shape(prumer, prumer)
	{
